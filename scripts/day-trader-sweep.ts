...
// 5m/1d intentionally excluded from this pass (scope bound) — 5m needs far
// more API pagination per symbol for marginal day-trade value here, 1d needs
// multi-year history for a usable trade count. Can be added as a follow-up.
...
const out: any = { generatedAt: "2026-07-16", screenSizing: { leverage: LEVERAGE, marginPerTradePct: MARGIN_PCT }, symbols: {} };
...
writeFileSync("scripts/day-trader-sweep-output.json", JSON.stringify(out, null, 2));
console.log("\nWrote scripts/day-trader-sweep-output.json");
