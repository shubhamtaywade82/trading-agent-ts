...
function loadStrategiesFromPool(poolPath = "strategies.json"): { strategies: StrategyDef[]; leverage?: number; aiGate?: Partial<AiGateConfig>; aiModeOverride?: "ai" | "no-ai" } {
  ...
  return { strategies: out, leverage: cfg.config?.leverage, aiGate: aiGateCfg, aiModeOverride: aiGateCfg?.mode };
}
