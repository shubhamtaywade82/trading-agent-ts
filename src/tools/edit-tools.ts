...
export class PatchTool extends Tool {
  ...
  override get parameters() { return { type: "object", properties: { path: { type: "string" }, find: { type: "string" }, replace: { type: "string" } }, required: ["path", "find", "replace"] }; }
...
export class AppendTool extends Tool {
  ...
  override get parameters() { return { type: "object", properties: { path: { type: "string" }, content: { type: "string" } }, required: ["path", "content"] }; }
  async call(args: Record<string, unknown>) {
    const path = args["path"] as string;
